...
class SignalingReadyCoordinatorTest extends ServiceIntegrationHelper {
    ...
    class RecordJoin {
        ...
        void onlyOneJoin_addsToJoinedSetOnly() {
            ...
            final CallHistory callHistory = CallHistory.start(1L, 2L, roomId, STARTED_AT);

            // when
            readyCoordinator.recordJoinAndAnnounceIfReady(callHistory, 1L);
        ...
        void bothJoin_acquiresReadyLock() {
            ...
            // when
            readyCoordinator.recordJoinAndAnnounceIfReady(callHistory, 1L);
            readyCoordinator.recordJoinAndAnnounceIfReady(callHistory, 2L);
