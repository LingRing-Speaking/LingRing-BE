...
public record MatchingStatusResponse(
    ...
    public static MatchingStatusResponse waiting() {
        return new MatchingStatusResponse(MatchingPollStatus.WAITING, null, null, null);
    }

    public static MatchingStatusResponse awaitingConfirm(final Long partnerId, final LocalDateTime confirmDeadline) {
        return new MatchingStatusResponse(MatchingPollStatus.AWAITING_CONFIRM, partnerId, null, confirmDeadline);
    }

    public static MatchingStatusResponse matched(final Long partnerId, final UUID roomId) {
        return new MatchingStatusResponse(MatchingPollStatus.MATCHED, partnerId, roomId, null);
    }

    public static MatchingStatusResponse none() {
        return new MatchingStatusResponse(MatchingPollStatus.NONE, null, null, null);
    }
}
